...
1.  * If you already have a file called `cabal.project` in your project directory,
      add `https://github.com/McEarl/ftlex/archive/refs/tags/v0.3.9.tar.gz`
      to `packages` there.
    ...
    * Otherwise, create a new file `cabal.project` that contains the following lines:
      ...
      packages:
        ./*.cabal
        https://github.com/McEarl/ftlex/archive/refs/tags/v0.3.9.tar.gz
      ```
...
1.  Add `https://github.com/McEarl/ftlex/archive/refs/tags/v0.3.9.tar.gz`
